...
<body>
	...
	<div id="corpo">
		...
		<a href="Verpauta.php" style="color: white;"><p>Clique Aqui</p> </a>
		<br> <br>
		<a href="Login.php"><input type="button" value="Iniciar Sessão"></a> 
		<p>Pretende fazer um cadastro?</p>
	<a href="Escolher.php" style="color: white;">	<p>Clique Aqui</p> </a>
